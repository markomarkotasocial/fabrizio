...
GitHub Actions / GitHub-based deployment — CI/CD to Azure
Features
Implemented
...
Configure connection strings and JWT settings in `fabrizio.API` (`appsettings.json` / user secrets)
...
```
   ...
   ```
Run the MAUI client (`fabrizio.App`) from Visual Studio, selecting your target platform (Android/iOS/Windows)
About This Project
